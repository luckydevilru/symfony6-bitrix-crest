...
namespace App\Service;
     ...
     *  define:
     */
    define('C_REST_CLIENT_ID',$_ENV['C_REST_CLIENT_ID']);//Application ID
    define('C_REST_CLIENT_SECRET',$_ENV['C_REST_CLIENT_SECRET']);//Application key
    // or
    //define('C_REST_WEB_HOOK_URL','https://dev6-bitrix.frhc.group/rest/');//url on creat Webhook

    //define('C_REST_CURRENT_ENCODING','windows-1251');
    define('C_REST_IGNORE_SSL',$_ENV['C_REST_IGNORE_SSL']);//turn off validate ssl by curl

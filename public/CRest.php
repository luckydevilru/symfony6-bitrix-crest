<?php
     ...
     *  define:
     */
    define('C_REST_CLIENT_ID','local.6423fe25549889.05184183');//Application ID
    define('C_REST_CLIENT_SECRET','MltDcJAjd6YF4p0U3ubAoD2LVRX31S6uM9M5mwS1ZJvyJW5kZv');//Application key
    // or
    //define('C_REST_WEB_HOOK_URL','https://dev6-bitrix.frhc.group/rest/1/doutwqkjxgc3mgc1/');//url on creat Webhook
